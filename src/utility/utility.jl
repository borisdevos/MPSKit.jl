...
function add_util_mpoleg(tensor::AbstractTensorMap{S,N1,N2}) where {S,N1,N2} 
    # separate function for mpoham because add_util_leg is also used for mps from tensors
